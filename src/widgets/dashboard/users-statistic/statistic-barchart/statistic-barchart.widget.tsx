                ...
                <Stack>
                    <ScrollArea h={400} offsetScrollbars type="always">
                        <Table highlightOnHover striped withTableBorder>
                            <Table.Thead>
                                <Table.Tr>
                                    <Table.Th>{t('statistic-users.component.user')}</Table.Th>
                ...
                options={{
                    ...
                    tooltip: {
                        ...
                        formatter() {
                            ...
                            const totalInThisDay = this.series.chart.series.reduce((sum, item) => {
                            ...
                            const maxValue = Math.max(...nearbyDays.map((day) => day.value), 1)
                            let nearbyDaysHtml = ''
